...
<head>
  ...
  <style>
    ...
    .greeting-bar h2 { font-size: 24px; font-weight: 700; margin: 0; }
    .greeting-bar p { font-size: 14px; color: #555; margin: 4px 0 0; }
    ...
    .stat-card .label { font-size: 12px; letter-spacing: 1px; color: #999; text-transform: uppercase; }
    .stat-card .value { font-size: 32px; font-weight: 700; letter-spacing: -1px; margin: 6px 0 2px; }
    .stat-card .sub { font-size: 13px; color: #777; }
    ...
    .action-card:hover { transform: translateY(-4px); box-shadow: 0 8px 30px rgba(0,0,0,0.1); color: #000; }
    .action-icon {
    ...
    .action-card h6 { font-weight: 700; font-size: 15px; margin: 0 0 3px; }
    ...
    .order-row { padding: 12px 0; border-bottom: 1px solid #f5f5f5; font-size: 14px; }
    ...
    .btn-black { background:#000;color:#fff;border:none;border-radius:999px;padding:10px 24px;font-size:13px;font-weight:600;cursor:pointer;transition:.2s;text-decoration:none;display:inline-block; }
    .btn-black:hover { background:#222;color:#fff; }
    .btn-outline { background:transparent;color:#000;border:1.5px solid #000;border-radius:999px;padding:9px 22px;font-size:13px;font-weight:600;cursor:pointer;transition:.2s;text-decoration:none;display:inline-block; }
    ...
    <div class="row g-3 mb-4">
      <div class="col-6 col-md-3">
        <div class="stat-card">
          ...
          <div class="sub">Earn 1pt per RM1</div>
        </div>
      </div>
      <div class="col-6 col-md-3">
        <div class="stat-card">
    ...
    <div class="row g-3 mb-4">
      <div class="col-6 col-md-3">
        <a href="products.php" class="action-card">
          ...
          <div><h6>Shop</h6><p>Browse products</p></div>
        </a>
      </div>
      <div class="col-6 col-md-3">
        <a href="cart.php" class="action-card">
          <div class="action-icon">🛒</div>
          <div><h6>My Cart</h6><p>Review items</p></div>
        </a>
      </div>
      <div class="col-6 col-md-3">
        <a href="profile.php" class="action-card">
          <div class="action-icon">👤</div>
          <div><h6>Profile</h6><p>Edit your info</p></div>
        </a>
      </div>
      <div class="col-6 col-md-3">
        <a href="logout.php" class="action-card">
          <div class="action-icon">🚪</div>
          <div><h6>Logout</h6><p>Sign out</p></div>
        </a>
      </div>
    </div>
