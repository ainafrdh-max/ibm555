        ...
        <div class="accordion" id="mainAccordion">
          ...
          <div class="accordion-item faq-item" data-category="privacy">
            ...
            <div id="ansPrivacy" class="accordion-collapse collapse">
              <div class="accordion-body">
                ...
                We respect the privacy of your personal information and we strive to maintain the confidentiality of
                your personal information given by you. The objective of collecting your personal data is to deliver
                products and services, future marketing purposes and to improve our services to you. Only our authorized
                employees have access to your personal information. We will not disclose information about our customers
                to third parties except where it is part of providing a service to you – e.g. arranging for a product to
                be sent to you, carrying out credit and other security checks and for the purposes of customer research
                and profiling or where we have your express permission to do so. We may also be required to disclose
                such information to regulators, lawyers, auditors, other companies in the same group, third party
                service providers and appointed marketing agency.
                <br><br>

                <strong>Your Consent</strong><br>
                We will not sell your name, address, e-mail address, credit card information or personal information to
                any third party (excluding partners from whom you may have linked to our site) without your permission.
                <br><br>

                <strong>Communication & Marketing</strong><br>
                If you have made a purchase from our store we may occasionally update you on our latest products, news
                and special offers via e-mail, post & telephone. You will also be given the opportunity to receive such
                communications from us and selected third parties when you become a member of Blank Resources.
                <br><br>
                All Blank Resources members have the option to opt-out of receiving marketing communications. You can
                unsubscribe via your account settings or using the unsubscribe link in emails.
                <br><br>

                <strong>What are Cookies?</strong><br>
                A cookie is a small information file stored on your device. It helps us remember your preferences and
                improve your experience. You may disable cookies through your browser settings.
                <br><br>

                <strong>Site Statistics</strong><br>
                We may collect anonymised usage data such as page visits and browsing behaviour to improve our services.
                This information does not identify individual users.
                <br><br>

                <strong>Disclosures of your information</strong><br>
                We may share your data with group companies or third parties only when necessary for business
                operations, legal compliance, fraud prevention, or company restructuring.
                <br><br>
                ...
                practices and encourage users to review their policies before submitting personal data.
                <br><br>

                <strong>Checking Your Details</strong><br>
                You may request access to your personal data by contacting us. For security, we may require identity
                verification before disclosing information.
                <br><br>

                <strong>Contacting Us</strong><br>
                If you have any questions about this Privacy Policy or wish to update or remove your information, please
                contact the Blank Resources team.
          ...
          <div class="accordion-item faq-item" data-category="terms">
            ...
            <div id="ansTerms" class="accordion-collapse collapse">
              <div class="accordion-body">
                Welcome to Blank Resources for online store. Terms and conditions stated below applies to all visitors
                and users of https://www.blankhq.com.my/. You are bound by these terms and conditions as long as you’re
                on https://www.blankhq.com.my/
                <br><br>

                <strong>General</strong><br>
                The content of terms and conditions may be change, move or delete at any time. Please note that
                https://www.blankhq.com.my/ have the rights to change the contents of the terms and conditions without
                any notice. Any violation of rules and regulations of these terms and conditions,
                https://www.blankhq.com.my/ will take immediate actions against the offender(s).
                <br><br>
                ...
                video clips, and written and other materials that appear as part of this Site, in other words “Contents
                of the Site” are copyrights, trademarks, trade dress and/or other intellectual properties owned,
                controlled or licensed by Blank Resources.
                <br><br>
                ...
                User shall agree that there will be no comment(s) submitted to the https://www.blankhq.com.my/ will
                violate any rights of any third party, including copyrights, trademarks, privacy of other personal or
                proprietary right(s). Furthermore, the user shall agree there will not be content of unlawful, abusive,
                or obscene material(s) submitted to the site. User will be the only one responsible for any comment’s
                content made.
                <br><br>

                <strong>Product Information</strong><br>
                We cannot guarantee all actual products will be exactly the same shown on the monitor as that is
                depending on the user monitor.
                <br><br>

                <strong>Newsletter</strong><br>
                User shall agree that https://www.blankhq.com.my/ may send newsletter regarding the latest
                news/products/promotions etc through email to the user.
                <br><br>

                <strong>Indemnification</strong><br>
                The user shall agree to defend, indemnify and hold https://www.blankhq.com.my/ harmless from and against
                ...
                Any access link to third party sites is at your own https://www.blankhq.com.my/ will not be related or
                involve to any such website if the user’s content/product(s) got damaged or loss have any connection
                with third party site.
                <br><br>

                <strong>Inaccuracy Information</strong><br>
                From time to time, there may be information on https://www.blankhq.com.my/ that contains typographical
                error, inaccuracies, omissions, that may relate to product description, pricing, availability and
                article contents. We reserve the rights to correct any errors, inaccuracies, change or edit information
                without prior notice to the customers. If you are not satisfy with your purchased product(s), please
                return it back to us with the invoice.
                <br><br>

                <strong>Termination</strong><br>
                This agreement is effective unless and until either by the customer or https://www.blankhq.com.my/.
                Customer may terminate this agreement at any time. However, https://www.blankhq.com.my/ may also
                terminate the agreement with the customer without any prior notice and will be denying the access of the
                customer who is unable to comply the terms and conditions above.
                <br><br>

                <strong>Shipping and Delivery Policy</strong><br>
                Items in stock: 2-5 working days for Standard Delivery items. Items that are out of stock: Please email
                ...
                methods we have available, such as Visa, MasterCard or online payment methods.<br><br>

                Payments cards (credit cards or debit cards) are subject to validation checks and authorization by Your
          ...
          <div class="accordion-item faq-item" data-category="shipping">
            ...
            <div id="ansShipping" class="accordion-collapse collapse">
              <div class="accordion-body">
                ...
                If you cancel your order(s) before it ships from our warehouse, you will not be charged any additional
                fees. We require a cancellation request to be submitted by emailing us at app@blankhq.com.my<br><br>
                Once the cancellation request is received, a full refund will be initiated. We would advise a
                cancellation request within 12 hours upon your order submission in order for a cancellation prior to
                goods shipment.
                <br><br>

                <strong>Return Policy</strong><br>
                The following are the policies to be eligible for return requests after shipment/ receipt of goods:<br>
                1. All goods sold are non-refundable except (i) Failed Delivery (ii) Wrong Delivery and (iii) Damaged
                good during delivery.<br>
                2. Only items purchased directly from app@blankhq.com.my Online Store are eligible for return.<br>
                3. Products purchased through other retailers are not eligible and must follow respective retailer
                policies.<br>
                ...
                Customers will be responsible for return shipping charges. Items must be returned within 7 working days
                with proof of purchase, in original packaging, unused, and in new condition.<br>
                ...
                We ship only to valid addresses provided during checkout. P.O. Boxes are not accepted. Incorrect address
                submissions may result in additional re-delivery charges.
                <br><br>
                Requests to change shipping address must be made within 12 hours of order submission. Changes after 24
                hours may incur additional shipping charges.
                <br><br>
                Delivery typically takes 2–5 working days (Monday–Friday, 9:00 am–5:00 pm).
                <br><br>

                <strong>Tracking Number</strong><br>
                Tracking details will be provided once the order is shipped. Updates will be communicated via email,
                SMS, or mobile app.
                <br><br>
